...
const Toast = ({ message, type }: { message: string | null; type: 'error' | 'success' }) => {
  ...
  return (
    <div
      className={`fixed z-50 top-4 m-4 px-4 py-2 flex min-h-10 w-56 ${background} text-white rounded-lg ${
